ucinit() {
  ...
  copy -- \
    ...
    $UC_INIT/tool/uc/part/-ucbuild-env-local,uc.bash .env-local.sh \
    $UC_INIT/tool/uc/part/-ucbuild-env-pack,uc.bash .env-pack.sh \
    $UC_INIT/tool/uc/part/-ucbuild-env-static,uc.bash .env-static.sh \
    $UC_INIT/tool/uc/part/-ucbuild-env-default,do,uc.bash .env.sh.do \
    $UC_INIT/tool/sh/part/init-env,uc.bash .init-env.sh \
    $UC_INIT/tool/sh/part/local-env,uc.bash .local-env.sh \
